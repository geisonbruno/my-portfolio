...
const SocialSection = () => {
  return (
    <section id="social" className="py-20 min-h-screen bg-muted/30 dark:bg-gray-900/50">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-lg mb-10 text-muted-foreground dark:text-gray-300">
          ...
          <div className="flex justify-center gap-6 mb-12">
            {socialLinks.map((link, index) => (
              <a 
                ...
                className={`p-4 flex flex-col items-center justify-center rounded-lg border transition-colors ${link.color} w-32`}
              >
                {link.icon}
          ...
          <div className="mt-12">
            <h3 className="text-2xl font-bold mb-4 dark:text-white">Entre em contato</h3>
            <p className="text-muted-foreground dark:text-gray-300 mb-6">
              Prefere email? Envie uma mensagem diretamente para mim.
            </p>
            <Button className="mt-4 dark:bg-blue-600 dark:hover:bg-blue-700">
