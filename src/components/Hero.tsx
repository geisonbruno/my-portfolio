...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center relative px-4 dark:bg-gray-900">
      <div className="container mx-auto">
        <div className="text-left space-y-4 sm:space-y-6 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <Button
